    ...
    <Modal title="Profile Information" fn={fn} >
      <div className="flex flex-col gap-7">
          ...
          <div className="py-4  flex gap-5">
            ...
            <div className="">
              <div className="flex gap-3">
                <span className="text-sm cursor-pointer text-green-700">Update</span>
                <span className="text-sm cursor-pointer text-red-700">Remove</span>
              </div>
        ...
        <div>
          ...
          <input type="text" className="outline-none bg-gray-100 rounded w-full py-2 px-3" value="priyashuk" />
        </div>
        <div>
          <label className="text-xs font-medium">Pronouns</label>
          <input type="text" className="outline-none bg-gray-100 rounded w-full py-2 px-3" />
        </div>
        <div>
