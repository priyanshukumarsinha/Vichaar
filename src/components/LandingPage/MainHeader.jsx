...
const MainHeader = ({
  ...
  return (
    <header className="flex justify-between w-full items-center border-b border-black py-5 px-[20px] lg:px-[170px]">
      <Logo />
      <nav className="w-2/3 text-sm flex justify-end gap-6 items-center">
        <ul className="justify-end gap-6 hidden lg:flex ">
          ...
          <li
            ...
            className="cursor-pointer hover:text-gray-800 transition-all duration-100 ease-in-out"
          >
            Sign In
          </li>
        </ul>
