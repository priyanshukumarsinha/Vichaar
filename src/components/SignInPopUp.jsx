...
const SignInPopUp = ({
  ...
  return (
    <div className="flex z-50 justify-center items-center bg-transparent backdrop-blur-lg absolute w-full">
      <motion.div
        className="h-screen relative px-3 md:w-1/2 bg-white translate-x-1/2 shadow-lg flex flex-col justify-center items-center"
      ...
      >
        ...
        <p className="text-xs m-5 p-5 text-gray-700">
          ...
          <a href="" className="underline text-gray-600 text-xs">
            Get help.
          </a>
        </p>
        <PopupFooter />
